...
const Home = () => {
  ...
  return (
    <>
      <h1>Welcome to CollectiBuddy! Please log in or Sign Up to begin your Collection</h1>
      ...
      <h1>Looking for a way to keep track of all your favorite collectibles in one place? We are happy to say that you need to look no further and as a member of CollectiBuddy you can save an online log of all your prescious collectibles. Sort them, edit their conditions, and event stage them for auction.</h1>
    </>
  )
}
