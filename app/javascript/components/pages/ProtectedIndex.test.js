...
describe("<ProtectedIndex />", () => {
  beforeEach(() => {
    ...
    const userCollection = [
      {
        id:1, name: "Cpt. Rex", category: "Action Figure", description: "Clone Trooper from Star Wars", condition: 'Like New', image: 'https://static.wikia.nocookie.net/heathcliff/images/b/b8/Heathcliff_promotional.png/revision/latest?cb=20210522181311g', user_id: 1
      }
    ]
    render(
      <BrowserRouter>
        <ProtectedIndex collections={userCollection} current_user={current_user}/>
      </BrowserRouter>
    )
  })
